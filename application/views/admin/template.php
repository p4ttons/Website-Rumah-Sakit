<head>
    ...
    <title>Sistem Admin RSUD Dewantara</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2"><?php echo anchor('Admin/home','Welcome Admin');?></span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
                <div data-i18n="Analytics" style="margin-left: 20px"><?php echo anchor('Admin/home','Home');?></div>
              </a>
            </li>
            <br>
            <!-- Tabel -->
            
                <div data-i18n="Tables" style="margin-left: 20px"><?php echo anchor('Admin/news_cat','Dashboard');?></div>
                <br>
                <div data-i18n="Tables" style="margin-left: 20px"><?php echo anchor('Admin/news','Kategori Dokter');?></div>
                <br>
                <div data-i18n="Tables" style="margin-left: 20px"><?php echo anchor('Admin/kontak','Kontak');?></div>
                <br>
                <div data-i18n="Tables" style="margin-left: 20px"><?php echo anchor('Admin/customer','Customer');?></div>
                <br>
                <div data-i18n="Without navbar" style="margin-left: 20px"><?php echo anchor('Admin/login/logout','Logout');?></div>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?php echo base_url()?>assets/admin//assets/img/avatars/1.jpg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Risky Riswanto</span>
                    ...
                    <li>
                        ...
                        <i class="bx bx-power-off me-2" style="margin-left: 20px"><?php echo anchor('Admin/login/logout','LOGOUT');?></i>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with  by
                  <a href="" target="_blank" class="footer-link fw-bolder">Risky Riswanto</a>
                </div>
                <div>
